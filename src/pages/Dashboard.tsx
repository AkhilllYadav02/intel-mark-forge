...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      {/* Sidebar */}
      <aside className={`bg-white border-r border-gray-200 transition-all duration-300 ${sidebarOpen ? 'w-64' : 'w-16'}`}>
        <div className="p-4">
          <div className="flex items-center space-x-3 mb-8">
            ...
            {sidebarOpen && (
              <span className="text-lg font-bold text-gray-900">IntelMarkForge</span>
            )}
          </div>
